from huggingface_hub import HfApi, dataset_info, model_info
...
print(
    f"Community Models: Downloads: {community_model_downloads}, Likes: {community_model_likes}"
)
print(f"Datasets: Downloads: {dataset_downloads}, Likes: {dataset_likes}")

print(
    f"Total self downloads: {self_model_downloads + dataset_downloads}, Total self likes: {self_model_likes + dataset_likes}"
)
